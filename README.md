...
* **[Licence](licence)** -> GPL v2 ([choose a licence](http://choosealicense.com/))
...
*  **[useful_ressources.md](useful_ressources.md)** -> a list of recommended ressources to either begin, discover or learn more on various topics of machine/deep learning.
